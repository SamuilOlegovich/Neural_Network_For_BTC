...
public enum Enums {
    ...
    HISTORY_FOR_FORTUNETELLER_FILE_NOT_DETECTED,
    ФАЙЛ_ИСТОРИИ_ДЛЯ_ПРЕДСКАЗАТЕЛЯ_НЕ_ОБНАРУЖЕНО,
    ...
    HISTORY_FOR_FORTUNETELLER_SUCCESSFULLY_READ,
    ИСТОРИЯ_ДЛЯ_ПРЕДСКАЗАТЕЛЯ_УСПЕШНО_СЧИТАНА,
    ...
    HISTORY_FOR_FORTUNETELLER_NOT_SAVED,
    ИСТОРИЮ_ДЛЯ_ПРЕДСКАЗАТЕЛЯ_НЕ_УДАЛОСЬ_СОХРАНИТЬ,
    DATE_TIME,
    ERROR,
    ID,
    SIZE,
